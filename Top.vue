  ...
  transition(name="fade")
    .menu(v-if="on")
      .container
        ...
        .options
          router-link.option(to="/",@click.native="scrollTo('#Projects')").is-h4 Tours
          router-link.option(to="/about",@click.native="on = false").is-h4 Services
          router-link.option(to="/recommendation",@click.native="on = false").is-h4 Recommendations
          router-link.option(to="/contact",@click.native="on = false").is-h4 Contact Us
