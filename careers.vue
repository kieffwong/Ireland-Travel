...
#Jobs.page
  ...
  .container
    ...
    .jobs-list
      .job
        .title.is-h4(v-in-viewport.once) GRAPHIC DESIGNER  
      ...
      .job
        .title.is-h1(v-in-viewport.once) Sales
        .subtitle.is-h2(v-in-viewport.once) Responsibilities
        ul(v-in-viewport.once)
    ...
    .apply(v-in-viewport.once) To apply for a position, please submit a resume and portfolio to 
      a(href="mailto:campoinvest@gmail.com").is-bunker campoinvest@gmail.com.
